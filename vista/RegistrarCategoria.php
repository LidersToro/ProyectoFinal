         ...
         <div class="main-panel">
             ...
             <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                 <div class="container-fluid">
                     <a class="navbar-brand" href="categoriagestion.php"> Gestion de Categoria </a>
                                        ...
                                        <!-- Segunda Fila -->
                                            ...
                                            <div class="col-md-3 px-1">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="txtArea" style="margin-top: 0px; margin-bottom: 0px; height: 100px;" required></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-3 px-1">
                                                <div class="form-group">
