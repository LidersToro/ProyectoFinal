...
print "                                            <button type=\"submit\" onclick=\"location.href='EditarMotoquero.php ? pid=$fila[0]&pnombre=$fila[1]&pcorreo=$fila[2]&pcontrasena=$fila[3]&pci=$fila[4]&pplaca=$fila[5]&pestado=$fila[6]&ptelefono=$fila[8]'\" rel=\"tooltip\" title=\"Editar\" name = \"editar$fila[0]\" value = \"$fila[0]\" class=\"btn btn-info btn-simple btn-link\">\n";
