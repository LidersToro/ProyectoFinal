                                        ...
                                        <div class="row">
                                            <div class="col-md-1 pr-1">
                                                <div class="form-group">
                                                    <label>ID</label>
                                                    <input type="text" class="form-control" disabled="" placeholder="#" value="<?php echo $siguiente; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="txtClave" class="form-control" placeholder="CONTRASENA">
                                                </div>
                                            </div>
                                             <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">CONFIRMAR CONTRASENA</label>
                                                    <input type="password" name ="txtClave2" class="form-control" placeholder="CONFIRMAR CONTRASENA">
                                                </div>
                                            </div>
